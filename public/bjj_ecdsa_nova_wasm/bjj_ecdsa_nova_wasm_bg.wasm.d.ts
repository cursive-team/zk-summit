...
export function prove_spartan(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function verify_spartan(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc60c9e3b09e25594(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h2cb2639cde712b77(a: number, b: number, c: number, d: number): void;
